...
| 6 | [235. Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/description/) | [Code](dsa/Trees/lca-bst.java) | Easy | DFS | No | if both descendants greater than root then check right tree if smaller then left tree else root is ans. |
| 7 | [450. Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst/description/) | [Code](dsa/Trees/delete-node-bst.java) | Medium | basic Tree | Yes | Leaf Node: Just delete it.  One Child: Replace node with its only child.  Two Children: Replace with inorder predecessor (rightmost of left subtree) or inorder successor (leftmost of right subtree). We’ll use predecessor here. |
