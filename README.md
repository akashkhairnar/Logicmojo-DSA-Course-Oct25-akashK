...
| 5 | [42. Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) | [Code](dsa/Array/trapping-rain-water.java) | Medium | two pointer(without space) | yes | store max left & right heigh for every index then caculate trap water |
