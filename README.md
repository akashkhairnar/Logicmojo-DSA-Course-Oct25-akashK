...
| 2 | [104. Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/description/) | [Code](dsa/Trees/depth-of-binary-tree.java) | Easy | DFS | No | height of BST = 1 + Math.max( height(root.left),height(root.right))  (DFS) |
| 3 | [144. Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/description/) | [Code](dsa/Trees/preorder-traversal.java) | Easy | recursion | No | ROOT->LEFT->RIGHT |
| 4 | [226. Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/description/) | [Code](dsa/Trees/invert-binary-tree.java) | Easy | Recursion DFS(PREORDER) | No | Swap left child and right child if current node is not null |
| 5 | [450. Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst/description/) | [Code](dsa/Trees/delete-node-bst.java) | Medium | basic Tree | Yes | Leaf Node: Just delete it.  One Child: Replace node with its only child.  Two Children: Replace with inorder predecessor (rightmost of left subtree) or inorder successor (leftmost of right subtree). We’ll use predecessor here. |
| 6 | [543. Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/description/) | [Code](dsa/Trees/diameter-of-tree.java) | Easy | DFS | No | calculate height of each left and right each node max dia and lh+rh is ans |
| 7 | [701. Insert into a Binary Search Tree](https://leetcode.com/problems/insert-into-a-binary-search-tree/description/) | [Code](dsa/Trees/insert-into-bst.java) | Easy | Simple BST | No | both way recursion & iteration |
